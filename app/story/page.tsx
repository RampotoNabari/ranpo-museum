const generations = [
  ...
  },
  {
    ...
    name: "辻　せき",
    role: "乱歩と対面した人",
    story: `昭和27年9月27日。\n\n江戸川乱歩が、生まれ故郷・名張へ帰ってきた。その場に立ち会ったのが、辻せきだった。\n\nせきは後に日記にこう記している。「本名　平井太郎君　江戸川らん歩さん　御母さんの乳ぶさにすがる姿　目に浮かぶ」\n\n乱歩はそのとき59歳だった（数え歳）。せきが思わず「まあ、大きくなられて！」と声をかけると、乱歩は静かに微笑んだという。\n\nせきはその表情を、生涯忘れなかった。`,
  },
  {
    number: "三",
    year: "昭和30年（1955年）",
